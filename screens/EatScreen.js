      ...
      <View style={styles.cardsWrapper}>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.cardInfo}>
            <Text style={styles.cardTitle}> Fast Food </Text>
            <Text style={styles.cardDetails}>
            Fast food is food quickly prepared and served, 
             less nutritious items like hamburgers, 
        ...
        <View style={styles.card}>
          ...
          <View style={styles.cardInfo}>
            <Text style={styles.cardTitle}>Tradiational Desi Food</Text>
            <Text style={styles.cardDetails}>
            Pakistani cuisine consists of a 
            variety of regional and traditional cuisines native to pakistan.
            </Text>
          </View>
        </View>
        <View style={styles.card}>
          ...
          <View style={styles.cardInfo}>
            <Text style={styles.cardTitle}>Chinese Food</Text>
            <Text style={styles.cardDetails}>
            A carbohydrate or starch like noodles, rice or buns.
             fish and meat.
            </Text>
          </View>
        </View>
